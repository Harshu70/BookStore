...
function Navbar() {
  ...
  return (
    <>
      <div
        className={`z-10 navbar bg-base-200 max-w-screen-2xl container mx-auto md:px-20 px-4 dark:bg-slate-900 dark:text-white fixed top-0 left-0 right-0 ${
          sticky
            ? "bg-base-300 dark:bg-slate-700 shadow-md duration-200 transition-all ease-in-out"
            : ""
        }`}
      >
        ...
        <div className="navbar-end">
          ...
          <label className="swap swap-rotate">
            ...
            {/* sun icon */}
            <svg
              className="swap-off h-7 w-7 fill-current ml-3"
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 24 24"
            ...
            {/* moon icon */}
            <svg
              className="swap-on h-7 w-7 fill-current ml-3"
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 24 24"
